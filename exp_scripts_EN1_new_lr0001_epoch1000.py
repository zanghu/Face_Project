...
#1.读取数据集
dsy_train = YiSunEN1(which_set='train', start=0, stop=10000, gcn_zca=True, y_float=True, one_zero=False)
dsy_test = YiSunEN1(which_set='test', start=0, stop=3466, gcn_zca=True, y_float=True, one_zero=False)
...
extensions = [MonitorBasedSaveBest(channel_name='test_objective', save_path='concolutional_network_best_EN1.pkl')]#, \
